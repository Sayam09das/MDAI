        ...
        <div className="flex flex-col h-full bg-white border-r border-slate-200">
            ...
            <div className="p-4 border-t border-slate-200">
                <div className={`flex items-center mb-3 ${isCollapsed ? 'justify-center' : 'space-x-3'}`}>
                    <div className="w-10 h-10 bg-gradient-to-br from-indigo-400 to-cyan-400 rounded-full flex items-center justify-center text-white font-semibold text-sm">
                        AD
                    </div>
                    {!isCollapsed && (
                ...
                <button
                    ...
                    className={`w-full flex items-center px-4 py-2.5 text-red-600 hover:bg-red-50 rounded-lg transition-colors ${isCollapsed ? 'justify-center' : 'space-x-3'}`}
                >
