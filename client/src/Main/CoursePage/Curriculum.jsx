            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className={`w-full p-5 md:p-6 text-left transition-all duration-300 ${
                    module.locked ? 'cursor-not-allowed' : 'cursor-pointer hover:bg-gray-50'
                  }`}
                    ...
                    <div className="p-4 md:p-6 bg-gray-50 space-y-3">
                      {module.items.map((lesson, lessonIndex) => {
                        ...
                        return (
                          <div
                            key={lesson.id}
                            className={`bg-white rounded-xl p-4 md:p-5 shadow-sm border transition-all duration-300 ${
                              isCompleted 
