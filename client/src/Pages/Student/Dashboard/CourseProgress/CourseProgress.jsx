...
import { 
  CheckCircle2, Circle, Play, Clock, Award, BookOpen, 
  ChevronDown, ChevronUp, Filter, Share2, 
  Video, FileText, Code, Headphones, Eye, X, Menu,
...
const CourseProgress = () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        if (response.isCompleted) {
          setTimeout(() => {
            toast.success('🏆 Course Completed! Amazing achievement!', {
              position: "top-center",
              autoClose: 5000,
            });
          }, 1000);
  ...
  const handleLessonClick = (lesson) => {
    if (lesson.isCompleted) {
      toast.info(`Reviewing: ${lesson.title}`, { autoClose: 2000 });
    } else {
      toast.success(`Starting Lesson: ${lesson.title}`, { autoClose: 2000 });
    }
  };
  ...
  const calculateStats = () => {
    if (!courseDetail?.lessons) return { completed: 0, pending: 0, inProgress: 0 };
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      ...
      <div className="flex">
        ...
        {(showSidebar || window.innerWidth >= 1024) && (
          <div className="fixed lg:sticky top-0 left-0 w-72 sm:w-80 h-screen bg-white shadow-2xl z-50 overflow-y-auto lg:z-0">
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="mb-4 sm:mb-6">
                    ...
                    <div className="relative h-3 sm:h-4 bg-gray-200 rounded-full overflow-hidden">
                      <div
                        className="absolute h-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full transition-all duration-700"
              ...
              {filteredModules?.map((module, moduleIndex) => (
                ...
                >
                  ...
                  >
                    ...
                    <div className={`transition-transform duration-300 ${expandedModule === moduleIndex ? 'rotate-180' : ''}`}>
