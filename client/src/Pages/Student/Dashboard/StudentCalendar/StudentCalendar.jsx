...
import { formatDate, isToday, isSameDay, getCalendarDays } from '../../../../utils/dateUtils';
...
const StudentCalendar = () => {
  ...
  const monthHolidays = useMemo(() => {
    ...
    holidays.forEach(h => {
      holidayMap.set(h.date.split('-')[2], h);
    });
    return holidayMap;
  }, [holidays]);
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium transition-all shadow-lg shadow-blue-500/30"
            >
