...
const faqData = [
    {
        ...
        answer: "Navigate to 'My Courses' from your sidebar and click the 'Create Course' button. Fill in the course details including title, description, price, and add modules with lessons.",
        category: "courses"
    },
    {
        question: "How do I upload course resources?",
        answer: "Go to the course you want to add resources to, click on 'Resources' section, and use the upload button to add files, videos, or documents.",
        category: "courses"
    },
    {
        question: "How do I create and manage assignments?",
        answer: "Go to 'Assignments' from your sidebar and click 'Create Assignment'. Set the title, description, due date, and points. Students can then submit their work which you'll grade.",
        category: "assignments"
    },
    {
        question: "How do I create exams/quizzes?",
        answer: "Navigate to 'Exams / Quizzes' from your sidebar and click 'Create Exam'. You can add multiple choice, true/false, or short answer questions.",
        category: "exams"
    },
    {
        question: "How do I view student submissions?",
        answer: "Go to 'Assignments' from your sidebar, click on the assignment, and then click 'View Submissions' to see all student work and grade them.",
        category: "assignments"
    },
    {
        question: "How do I manage my finance/payments?",
        answer: "Go to 'Finance' from your sidebar to view your earnings, transaction history, and pending payments. You can also request withdrawals.",
        category: "finance"
    },
    {
        question: "How do I send announcements?",
        answer: "Navigate to 'Announcements' from your sidebar and create a new announcement. Students enrolled in your courses will receive notifications.",
        category: "communication"
    },
    {
        question: "How do I manage student complaints?",
        answer: "Go to 'Complaints' from your sidebar to view and respond to student complaints. You can resolve issues and provide explanations.",
        category: "complaints"
    }
];
...
// Contact Information
const contactInfo = {
    email: "teacher-support@mdai.com",
                ...
                >
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <a href="/teacher-dashboard/mycourse" className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                <BookOpen className="text-indigo-600" size={20} />
                                <span className="font-medium">My Courses</span>
                                <ExternalLink size={16} className="ml-auto text-gray-400" />
                            </a>
                            <a href="/teacher-dashboard/finance" className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                <DollarSign className="text-green-600" size={20} />
                                <span className="font-medium">Finance Dashboard</span>
                                <ExternalLink size={16} className="ml-auto text-gray-400" />
                            </a>
                            <a href="/teacher-dashboard/messages" className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                <MessageSquare className="text-blue-600" size={20} />
                                <span className="font-medium">Messages</span>
                                <ExternalLink size={16} className="ml-auto text-gray-400" />
                            </a>
                            <a href="/teacher-dashboard/complaints" className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                <Users className="text-orange-600" size={20} />
                                <span className="font-medium">Student Complaints</span>
                                <ExternalLink size={16} className="ml-auto text-gray-400" />
                            </a>
                        </div>
                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        >
                                            ...
                                            {recipients.filter(r => r.role === "student").length > 0 && (
