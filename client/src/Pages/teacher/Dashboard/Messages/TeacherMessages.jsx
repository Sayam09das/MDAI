...
const TeacherMessages = () => {
  ...
  const currentUserId = localStorage.getItem("teacherId") || localStorage.getItem("userId");
  const currentUserModel = "Teacher";
  ...
  const loadContacts = async () => {
    // For teachers, load their students
    try {
                ...
                {contacts.map((contact) => (
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <p className="text-xs text-gray-500">{contact.model === "User" ? "Student" : contact.model}</p>
                    </div>
                  </button>
                ))}
              </div>
        ...
        {selectedConversation ? (
          ...
          <div className="hidden md:flex flex-1 flex-col items-center justify-center bg-gray-50">
            ...
            <p className="text-gray-500 text-center max-w-sm">
              Select a conversation from the list to start chatting with your students.
            </p>
            <button
              onClick={() => {
                setShowNewChat(true);
