...
import { Search, BookOpen, FileText, Users, X, ArrowRight, Loader2 } from "lucide-react";
...
const SearchPage = () => {
    ...
    const handleSearchSubmit = (e) => {
        e?.preventDefault();
        if (localQuery.trim()) {
            navigate(`/teacher-dashboard/search?q=${encodeURIComponent(localQuery.trim())}`);
        }
    };
        ...
        <div className="px-4 sm:px-5 md:px-6 lg:px-8 py-6">
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600 mt-1">
                    Find your courses, resources, and students
                </p>
            </div>
